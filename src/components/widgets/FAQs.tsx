...
export default component$(() => {
  ...
  return (
    <section class="border-t text-[#457292] border-gray-200 dark:border-slate-800">
                  ...
                  <div key={index2}>
                    <div class="relative ">
                      <h6 class="mb-0 text-[#457292]">
                        ...
                        >
                          <h3 class="mb-4  text-xl font-bold hover:translate-x-4 transition ease-in-out duration-500 ">
